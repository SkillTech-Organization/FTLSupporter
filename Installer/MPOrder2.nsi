...
OutFile "MPOrderSetup.exe"
InstallDir "$PROGRAMFILES\MPOrder"
...
Section -AdditionalIcons
  CreateDirectory "$SMPROGRAMS\MPOrder"
  CreateShortCut "$SMPROGRAMS\MPOrder\Uninstall.lnk" "$INSTDIR\uninst.exe"
SectionEnd
