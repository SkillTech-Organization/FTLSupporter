    ...
    public class bllTruck : bllBase
    {
        ...
        public List<boTruck> GetAllTrucks(string p_where = "", params object[] p_pars)
        {
                        ...
                        select new boTruck
            {
                ...
                TRK_LENGTH = Util.getFieldValue<double>(rec, "TRK_LENGTH"),
                TRK_WIDTH = Util.getFieldValue<double>(rec, "TRK_WIDTH"),
                TRK_HEIGHT = Util.getFieldValue<double>(rec, "TRK_HEIGHT"),
