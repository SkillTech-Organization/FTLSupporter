...
namespace FTLSupporter
{
    ...
    public class FTLTruckX
    {

        public enum eTruckTaskTypeX
        {
            Available,                  // Elérhető
            Planned,                    // Tervezett
            Running                     // Futó
        ...
        public DateTime TimeCurr
        {
            ...
            {
                m_TimeCurr = value;
                if (TruckTaskType == eTruckTaskTypeX.Available)
                {
                    TimeFrom = value;
                    TimeTo = value;
                }
